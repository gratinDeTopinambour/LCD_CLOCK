...
/* USER CODE BEGIN EV */
extern volatile Flag system_flag;
/* USER CODE END EV */
...
void EXTI4_15_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(HEURE1_Pin);
  HAL_GPIO_EXTI_IRQHandler(HEURE2_Pin);
  HAL_GPIO_EXTI_IRQHandler(MINUT1_Pin);
  HAL_GPIO_EXTI_IRQHandler(MINUT2_Pin);
